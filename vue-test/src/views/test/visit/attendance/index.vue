<template>
  <view class="page">
    ...
    <view class="container">
      ...
      <view class="map">
        ...
        <map
          ...
          :latitude="vuex_location.latitude"
          :longitude="vuex_location.longitude"
          :show-location="true"
        />
        <view class="bottom">
      ...
      <view class="form">
        <u--form ref="uForm" :model="uFormModel" labelPosition="top" labelWidth="auto">
          <u-form-item label="拜访客户" prop="visitInfo.customName" :required="true">
            <u--input v-model="uFormModel.visitInfo.customName" suffixIcon="arrow-right" readonly @tap="customerSelection" />
          </u-form-item>
          <u-form-item label="拜访类型" prop="visitInfo.visitTypeLabel" :required="true">
            <u--input
          ...
          <u-form-item label="拜访方式" prop="visitInfo.visitingMethodsLabel" :required="true">
            <u--input
          ...
          <u-form-item label="销售阶段" prop="visitInfo.saleStageLabel" :required="true">
            <u--input
          ...
          <u-form-item label="我方拜访人" prop="visitInfo.ourVisitor" :required="true">
            <u--input v-model="uFormModel.visitInfo.ourVisitor" />
          </u-form-item>
          <u-form-item label="客户方接待人" prop="visitInfo.customerReception" :required="true">
            <u--input v-model="uFormModel.visitInfo.customerReception" />
          </u-form-item>
          <u-form-item label="拜访日期" prop="visitInfo.visitTimeLabel" :required="true" v-if="id">
            <u--input
          ...
          <u-form-item label="签到时间" prop="visitInfo.signInTimeLabel" v-if="id">
            <u--input
          ...
          <u-form-item label="下次拜访日期" prop="visitInfo.nextVisitDateLabel">
            <u--input
          ...
          <u-form-item label="商谈事项" prop="visitInfo.negotiateMatters">
            <u--textarea v-model="uFormModel.visitInfo.negotiateMatters" autoHeight />
          </u-form-item>
          <u-form-item label="结果评价" prop="visitInfo.resultEvaluation">
            <u--textarea v-model="uFormModel.visitInfo.resultEvaluation" autoHeight />
          </u-form-item>
          <u-form-item label="下次拜访事项" prop="visitInfo.nextVisitMatters">
    ...
    <!-- Region 拜访方式 -->
    <u-picker
      :show="show.visitingMethods"
      :columns="columns.visitingMethods"
      keyName="label"
      closeOnClickOverlay
...
export default {
  ...
  async onLoad({ id, customCode, customName }) {
    try {
      ...
      !this.id &&
        (this.signInTimeInterval = setInterval(() => {
      ...
      return new Promise((resolve, reject) => {
        ...
        Promise.all([crm_bffs, crm_xsjd])
          .then((res) => {
            ...
            resolve([this.dictExtract(crm_bffs), this.dictExtract(crm_xsjd)]);
          })
          .catch((err) => {
            reject(err);
          });
      ...
      uni.navigateTo({
        ...
        events: {
          selected: ({ name, id }) => {
            ...
            this.$refs.uForm.validateField("visitInfo.customOpportunitiesIdLabel");
          },
        },
      });
    },
