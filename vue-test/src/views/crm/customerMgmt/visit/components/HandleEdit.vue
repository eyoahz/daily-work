...
<script lang="ts" setup>
  ...
  import { getDetails, insert, update, customerPage } from '/@/api/customerMgmt/visit';
  ...
  function businessSelect(data) {
    closeModal();
    setFieldsValue({ customOpportunitiesName: data?.name, customOpportunitiesId: data?.id });
  }
</script>
